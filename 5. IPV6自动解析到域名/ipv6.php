...
$sub_domain 	=	"pad";
$record_type 	= 	"AAAA";
$token 			= 	"72319,de6d0312be8dea0762ff8050e77133a2";
...
while(true){
	...
	$local_ipv6_config = "";
	exec("ipconfig",$ipconfig_result);
	
	foreach ($ipconfig_result as $value) {
		if(stripos($value, "IPv6 Address") == 3){
			$local_ipv6_config = trim(explode(". :", $value)[1]);
		}
	}
